...
public class PedidoService {
    ...
    public Pedido crearPedido(Pedido pedido) {
        ...
        try {
            Map<String, Object> evento = Map.of(
                    ...
                    "correoCliente", pedidoGuardado.getUsuarioEmail(),
                    "estado", pedidoGuardado.getEstado().name(),
                    "total", pedidoGuardado.getTotal().doubleValue()
            );
            ...
            System.err.println(
                    "Error enviando evento a RabbitMQ: "
                            + e.getMessage()
            );
        }
    ...
    public List<Pedido> obtenerPorUsuario(String usuarioEmail) {
    ...
    public Pedido cambiarEstado(
        ...
        try {
            Map<String, Object> evento = Map.of(
                    "idPedido", actualizado.getId(),
                    "correoCliente", actualizado.getUsuarioEmail(),
                    "estado", actualizado.getEstado().name(),
                    "total", actualizado.getTotal().doubleValue()
            );
